...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj13372 = {};return obj13372;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__5507__auto__ = this$;if(and__5507__auto__)
...
{var x__6146__auto__ = (((this$ == null))?null:this$);return (function (){var or__5519__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__6146__auto__)]);if(or__5519__auto__)
{return or__5519__auto__;
} else
{var or__5519__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__5519__auto____$1)
...
return (function (p__13373){var vec__13374 = p__13373;var k = cljs.core.nth.call(null,vec__13374,(0),null);var v = cljs.core.nth.call(null,vec__13374,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__13375){var vec__13376 = p__13375;var k = cljs.core.nth.call(null,vec__13376,(0),null);var v = cljs.core.nth.call(null,vec__13376,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
